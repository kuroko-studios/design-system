...
- v0 (now): dark brand tokens + pipeline + preview.
- Next: harvest HQ's token-only primitives (Button, Card, Chip, Input, Pill, Table, Tabs)
  into a documented component library; a docs site built with the system.
